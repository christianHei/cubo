...
@Component({
  selector: 'app-lado-tres',
  templateUrl: './lado-tres.component.html',
  styleUrls: ['../lado.component.css', './lado-tres.component.css', ]
})
export class LadoTresComponent implements OnInit {
